...
Set graphics type for output figures, either \textit{pdf}, \textit{postscript},
\textit{png}, or \textit{windows}:
<<>>=
gr.type <- "pdf"
@
...
Plot non-field parameters from 1960 through 2012 (period-of-record):
<<>>=
...
Run trend analysis for censored-non-field parameters from 1989 through 2012:
<<>>=
...
Run trend analysis for uncensored-non-field parameters from 1960 through 2012:
<<>>=
...
Run trend analysis for uncensored-non-field parameters from 1989 through 2012:
<<>>=
out <- RunTrendAnalysis(d, par.config = par.config, plot.config = plot.config,
...
Run trend analysis for uncensored-field parameters from 1960 through 2012:
<<>>=
...
Run trend analysis for uncensored-field parameters from 1989 through 2012:
<<>>=
out <- RunTrendAnalysis(d, par.config = par.config, plot.config = plot.config,
                        sdate = "01/01/1989", edate = "01/01/2013", is.censored = FALSE,
