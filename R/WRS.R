...
# isub is a vector of length n, a bootstrap sample from the sequence of integers
# 1, 2, 3, ..., n
...
# Compute Theil-Sen regression estimator. Use Gauss-Seidel algorithm when there
